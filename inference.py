...
def make_inference(review, endpoint_name):
    """
    Sends a HTTP request encapsulating the input review to the input endpoint and prints the predicted sentiment. 
    ...
    # Creating the endpoint_url using the endpoint name and the AWS region. 
